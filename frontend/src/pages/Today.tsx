...
export default function Today(){
  ...
  return (<div className="page"><div className="page-head"><h2>今日 · {dateStr} · {plan.gradeKey} · {plan.weekTheme} {isPreview && <span className="badge">预习</span>}</h2>
    ...
    <div className="muted">校准：{calText} {isPreview && "· 预习包仅前4单元 10-15分钟/条"}</div>
  </div>
