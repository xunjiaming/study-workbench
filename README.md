...
本项目的权威口径以 \docs/REQUIREMENTS.md（需求框架 F1-F12，已冻结）与 \docs/DESIGN.md（方案草案 v2 已冻结）为准。
...
- [需求框架](docs/REQUIREMENTS.md)：F1-F12、学习原则、验收框架、决策冻结记录。
- [方案草案 v2](docs/DESIGN.md)：信息架构与路由、数据模型定稿、计划生成算法、内容流水线 SOP、技术栈与分阶段落地、验收映射。
